...
<body>
    ...
    <div class="regist">
<form action="Política.php" method="post">

    <h1>Bienvenido a "Política"</h1>
    ...
    <?php
        ...
        try {
            ...
            if(!empty($_POST)){
                ...
                $conexion->query("INSERT INTO `política` (`ID`, `nickname`, `comment`, `fecha`) VALUES (NULL, '$nick', '$comm', '$fech');");
            }

            $busca = $conexion->query("SELECT * FROM `política`");
